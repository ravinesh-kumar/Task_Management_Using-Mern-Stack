...
import { getTask, updateTask } from "../store/actions/taskActions";
...
export default function UpdateTask() {
  ...
  //     dispatch(updateTask({_id: _id,title: data.title,description: data.description, duedate: data.duedate,  }) );
  //     navigate("/tasklist");
  //   }
  function postData(e) {
    e.preventDefault();
